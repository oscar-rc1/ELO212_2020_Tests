...
create_project -force Sesion7_ELO212_Test1 -part xc7a100tcsg324-1 vivado/test1

read_verilog -sv tb/tb_act1.sv
...
set_property -name "top" -value "tb_act1" -objects [get_filesets sim_1]
